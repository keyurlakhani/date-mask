    ...
    app.directive('dateInputMask', function () {
      ...
      formats.forEach(function (f) {
        ...
        for (var index = pos; index < pos + f.length; index++) {
          ...
          validatorByIndex[index] = validator
        }
      })
      ...
      function dateInputMaskLinkFn(scope, element, attrs, ctrl) {
        ...
        function onKeyDown(event) {
          ...
          if ((input.value[index + 1] && input.value[index] !== separator) 
            ...
            const formatLength = formatLengthFn(index);
          ...
          var formatLength = formatLengthFn(index);
        ...
        function onInput(event) {
          ...
          if (!validatorByIndex[index + delta] 
              && isBeforeEnd 
